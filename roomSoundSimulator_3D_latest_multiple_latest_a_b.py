...
for l in range(1):
    ...
    for xx in range(len(a)):
        ...
        for yy in range(len(b)):
                      ...
                      for file in (files):
                        ...
                        if (str.find('speech') != -1 ):
                                ...
                                if file_index == 0:
                                   ...
                                   coherence1_with_smooth = double_exponential_smoothing(mic1_coherence_without_smooth, a[xx][0], b[yy][0])                     
                                   ...
                                   coherence2_with_smooth = double_exponential_smoothing(mic2_coherence_without_smooth, a[xx][0], b[yy][0])
            ...
            dataset["alpha"]  = a[xx][0]
            dataset["beta"]  = b[yy][0]            
        
            datasetFinal.append(dataset)         


with open ('1.0_datasetMSCFinal_list_a_b.pickle', 'wb' ) as f:
