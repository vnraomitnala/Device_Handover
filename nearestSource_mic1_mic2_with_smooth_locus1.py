          ...
          for file in (files):
            ...
            if (str.find('speech') != -1 ):
                    ...
                    if file_index == 0:
                       ...
                       print("mic1_coherence_without_smooth: ", mic1_coherence_without_smooth)
                       ...
                       print("mic1_coherence_with_smooth: ", mic1_coherence_with_smooth)
                    else:
                       ...
                       print("mic2_coherence_without_smooth: ", mic2_coherence_without_smooth)
                       ...
                       print("mic2_coherence_with_smooth: ", mic2_coherence_with_smooth)
...
with open ('C:/Users/Vijaya/PhD/1.8_linear_move_a_b.pickle', 'wb' ) as f:
